...
public class BusinessActivity extends BaseActivity {
    ...
    private void showData() {
        if (mCommonAdapter == null) {
            mLinearLayoutManager = new LinearLayoutManager(BusinessActivity.this);
            mRecyclerView.setLayoutManager(mLinearLayoutManager);
            mCommonAdapter = new CommonAdapter<String>(BusinessActivity.this, R.layout.layout_business, mStringList) {
                @Override
            ...
            mLoadMoreWrapper.setLoadMoreView(LayoutInflater.from(BusinessActivity.this).inflate(R.layout.footer_view_load_more, mRecyclerView, false));
...
//            mRecyclerView.addItemDecoration(new DividerGridItemDecoration(BusinessActivity.this, 0));
        } else {
