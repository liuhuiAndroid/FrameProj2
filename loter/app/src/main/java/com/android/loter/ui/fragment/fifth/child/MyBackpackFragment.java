...
public class MyBackpackFragment extends BaseBackFragment {
    ...
    public static MyBackpackFragment newInstance() {
        MyBackpackFragment baseFragment = new MyBackpackFragment();
        return baseFragment;
    }

    @Override
    protected int bindLayout() {
        return R.layout.fragment_my_backpack;
    }

    @Override
    protected void initData() {
        mTvTitle.setText("我的背包");
