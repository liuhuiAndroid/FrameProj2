...
public class FollowIdolFragment extends BaseBackFragment {
    ...
    public static BaseFragment newInstance() {
        FollowIdolFragment followIdolFragment = new FollowIdolFragment();
        return followIdolFragment;
    }

    @Override
    protected int bindLayout() {
        return R.layout.fragment_follow_idol;
    }

    @Override
    protected void initData() {
        mTvTitle.setText("我关注的红人");
