...
public class WithdrawCashDetailFragment extends BaseBackFragment {
    ...
    public static BaseFragment newInstance() {
        WithdrawCashDetailFragment withdrawCashFragment = new WithdrawCashDetailFragment();
        return withdrawCashFragment;
    }

    @Override
    protected int bindLayout() {
        return R.layout.fragment_withdraw_cash_detail;
    }
    ...
    private void showData() {
        if (mCommonAdapter == null) {
            ...
            mCommonAdapter = new CommonAdapter<String>(getActivity(), R.layout.layout_withdraw_cash, mStringList) {
                @Override
