...
public class BusinessSellerListFragment extends BaseFragment {
    ...
    public static BaseFragment newInstance() {
        BusinessSellerListFragment baseFragment = new BusinessSellerListFragment();
        return baseFragment;
    }

    @Override
    protected int bindLayout() {
        return R.layout.fragment_business_list_seller;
    }
