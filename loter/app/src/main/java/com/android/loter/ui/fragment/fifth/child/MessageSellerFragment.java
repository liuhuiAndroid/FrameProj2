...
public class MessageSellerFragment extends BaseFragment {
    ...
    public static BaseFragment newInstance() {
        MessageSellerFragment messageSellerFragment = new MessageSellerFragment();
        return messageSellerFragment;
    }
