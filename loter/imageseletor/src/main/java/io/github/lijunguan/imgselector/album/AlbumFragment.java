...
import static io.github.lijunguan.imgselector.cropimage.CropActivity.CROP_RESULT;
...
//                    showToast(getString(R.string.permission_denied_error_msg));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.i("TAG","AlbumFragment onCropCompleted");
    }
...
//        intent.putExtra(CROP_RESULT, imagePath);
//        getActivity().setResult(RESULT_OK, intent);
//        getActivity().finish();
        Intent intent = new Intent();
        intent.putExtra(CROP_RESULT, imagePath);
        onActivityResult(ImageSelector.REQUEST_CROP_IMAGE,RESULT_OK,intent);
    }
